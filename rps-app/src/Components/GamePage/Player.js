      ...
      return (
         <div className="game">
            ...
            <div className="selection-wrapper">
               <div className="selection-div" onClick={() => this.updateSelection("rock")}>
                  <img className="selection-image" src={rock} alt="rock" />
               </div>
               <div className="selection-div" onClick={() => this.updateSelection("paper")}>
                  <img className="selection-image" src={paper} alt="paper" />
               </div>
               <div className="selection-div" onClick={() => this.updateSelection("scissors")}>
